...
pointerMotionHandler([[maybe_unused]] void* data,
                     ...
                     [[maybe_unused]] wl_fixed_t surfaceY)
{
    frame::player.mouse.absX = wl_fixed_to_double(surfaceX);
    frame::player.mouse.absY = wl_fixed_to_double(surfaceY);
}
...
{
    frame::player.mouse.button = button;
    frame::player.mouse.state = buttonState;
}
